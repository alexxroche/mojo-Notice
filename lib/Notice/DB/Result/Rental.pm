...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CzRW+m9N+pUvy/+TCUMFTA
# These lines were loaded from '/usr/local/share/perl/5.10.0/Notice/DB/Result/Rental.pm' found in @INC.
...
1;
# End of lines loaded from '/usr/local/share/perl/5.10.0/Notice/DB/Result/Rental.pm' 
